...
```bash
python codecarbon_cli.py sample_task.py
```
...
This tool supports the movement toward **green software engineering** by helping developers quantify and reflect on the carbon footprint of their work.
